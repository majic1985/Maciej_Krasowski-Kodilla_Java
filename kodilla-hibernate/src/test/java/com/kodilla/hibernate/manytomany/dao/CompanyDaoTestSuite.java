...
public class CompanyDaoTestSuite {
    ...
    public void testSaveManyToMany() {
        ...
        //Then
        Assert.assertNotEquals(1, softwareMachineId);
        Assert.assertNotEquals(1, dataMastersId);
        Assert.assertNotEquals(1, greyMatterId);
    ...
    public void testEmployeeQuery() {
        ...
        Assert.assertNotEquals(0L, (long) employeesList.size());
    ...
    public void testCompanyNativeQuery() {
        ...
        Assert.assertNotEquals(1L, (long)companyNativeQuery.size());
